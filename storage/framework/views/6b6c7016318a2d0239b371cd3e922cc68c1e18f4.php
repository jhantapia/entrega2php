...
<?php $__env->startSection('content-subtitle', 'Autores'); ?>
                ...
                <div class="box-body">
                    <div id="toolbar" class="btn-group">
                        <button data-toggle="modal" data-target="#modal-create" class="btn btn-success"><i
                                    class="fa fa-plus"></i> Nuevo Autor
                        </button>
                    </div>
                    <table
                        id="table"
    ...
    <script>
        ...
        function ajaxRequest(params){
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('authors.all')); ?>",
        ...
        $(function () {
            $('#form-create').submit(function (e) {
                ...
                $.ajax({
                    type: 'post',
                    url: '<?php echo e(route('authors.store')); ?>',
                    data: dataForm,
                    success: function (data) {
        ...
        $(function () {
            $('#form-edit').submit(function (e) {
                ...
                e.preventDefault();
                var url = '<?php echo e(route('authors.update')); ?>';
                $.ajax({
                    type: 'POST',
                    url: url,
                    data: dataForm,
        ...
        function changeStatusToggle(rowId){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo e(route('authors.change-status')); ?>',
                data: {
        ...
        function remove(id){
            ...
            swal({
                ...
                if (result.value) {
                    ...
                    var url = '<?php echo e(route('authors.destroy')); ?>';
                    $.ajax({
                        type: 'POST',
                        url: url,
                        data: {
