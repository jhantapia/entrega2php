<?php $__env->startSection('content-title', 'Gestión de Usuarios'); ?>

<?php $__env->startSection('content-subtitle', 'Panel de Usuarios'); ?>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group col-md-12" id="group-error-avatar-create">
                                            ...
                                            <div class="image-avatar">
                                                <img id="image-avatar" src="<?php echo e(Storage::url('avatars/user-default.png')); ?>">
                                            </div>
                               ...
                               <div class="row">
                                   <div class="col-md-3">
                                       <div class="form-group col-md-12" id="group-error-avatar-edit">
                                           <label for="avatar">Avatar</label>
                                           <div class="image-avatar">
                                               <img id="image-avatar-edit" src="<?php echo e(Storage::url('avatars/user-default.png')); ?>">
                                           </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        function deleteAvatarCreate() {
            $('#modal-create #image-avatar').attr('src', '<?php echo e(Storage::url('avatars/user-default.png')); ?>');
            $('.link-del').html('');
            $("#modal-create #file").val('');
        }

        function deleteAvatarEdit() {
            $('#modal-edit #image-avatar-edit').attr('src', '<?php echo e(Storage::url('avatars/user-default.png')); ?>');
            $('.link-del').html('');
            $("#modal-edit #file").val('');
        }
    </script>
    ...
    <script>
        ...
        config.csrf_token = "<?php echo e(csrf_token()); ?>";

        config.urlGetAll = "<?php echo e(route('management.users.all')); ?>";
        config.urlStore = " <?php echo e(route('management.users.store')); ?>";
        config.urlUpdate = " <?php echo e(route('management.users.update')); ?>";
        config.urlDestroy = " <?php echo e(route('management.users.destroy')); ?>";
        config.urlChangeStatus = " <?php echo e(route('management.users.change-status')); ?>";
