...
<head>
    ...
    <title>MANTENEDOR BIBLIOTECA | <?php echo $__env->yieldContent('content-title'); ?></title>
...
<div class="wrapper">
        ...
        <section class="sidebar">
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="<?php echo e(Storage::url(Auth::user()->avatar)); ?>" class="img-circle">
                </div>
            ...
            <ul class="sidebar-menu" data-widget="tree" data-api="tree" data-accordion=0>
                ...
                <?php if(Auth::user()->load('role')->role->name == 'Administrador'): ?>
                    <?php echo $__env->make('layout.sidebars.admin-sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php elseif(Auth::user()->load('role')->role->name == 'Validador'): ?>
                    <?php echo $__env->make('layout.sidebars.cajero-sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php elseif(Auth::user()->load('role')->role->name == 'Constructor'): ?>
                    <?php echo $__env->make('layout.sidebars.cliente-sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php endif; ?>

                <li class="header">MENÚ USUARIO</li>
                <li <?php echo e((Request::is('profile') ? 'class=active' : '')); ?> >
                ...
                <li>
                    ...
                    <form id="form-logout"  method="post" action="<?php echo e(route('logout')); ?>">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <?php echo $__env->yieldContent('content-title', 'Nueva Página'); ?>
                <small> <?php echo $__env->yieldContent('content-subtitle', 'Nueva Página'); ?></small>
            </h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    <?php echo $__env->make('template._errors', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
