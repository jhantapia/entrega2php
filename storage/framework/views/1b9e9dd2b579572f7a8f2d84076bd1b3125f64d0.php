<?php $__env->startSection('content-title', 'Configuración'); ?>

<?php $__env->startSection('content-subtitle', 'Libros'); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group col-md-12" id="group-error-cover-create">
                                    ...
                                    <div class="image-cover">
                                        <img id="image-cover" class="img-thumbnail" height="370px" width="100%" src="<?php echo e(Storage::url('covers/cover-default.png')); ?>">
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group col-md-12" id="group-error-cover-edit">
                                    <label for="cover">Caratula del Libro</label>
                                    <div class="image-cover">
                                        <img id="image-cover-edit" class="img-thumbnail" height="370px" width="100%" src="<?php echo e(Storage::url('covers/cover-default.png')); ?>">
                                    </div>
    ...
    <script>
        ...
        function ajaxRequest(params){
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('books.all')); ?>",
        ...
        $(function () {
            $('#form-create').submit(function (e) {
                ...
                $.ajax({
                    type: 'post',
                    url: '<?php echo e(route('books.store')); ?>',
                    data: dataForm,
                    success: function (data) {
        ...
        $(function () {
            $('#form-edit').submit(function (e) {
                ...
                e.preventDefault();
                var url = '<?php echo e(route('books.update')); ?>';
                $.ajax({
                    type: 'POST',
                    url: url,
                    data: dataForm,
        ...
        function changeStatusToggle(rowId){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo e(route('books.change-status')); ?>',
                data: {
        ...
        function remove(id){
            ...
            swal({
                ...
                if (result.value) {
                    ...
                    var url = '<?php echo e(route('books.destroy')); ?>';
                    $.ajax({
                        type: 'POST',
                        url: url,
                        data: {
        ...
        function deleteAvatarCreate() {
            $('#modal-create #image-cover').attr('src', '<?php echo e(Storage::url('covers/cover-default.png')); ?>');
            $('.link-del').html('');
            $("#modal-create #file").val('');
        }

        function deleteAvatarEdit() {
            $('#modal-edit #image-cover-edit').attr('src', '<?php echo e(Storage::url('covers/cover-default.png')); ?>');
            $('.link-del').html('');
            $("#modal-edit #file").val('');
        }
