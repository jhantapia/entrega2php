...
<?php $__env->startSection('content-subtitle', 'Editoriales'); ?>
    ...
    <script>
        ...
        function ajaxRequest(params){
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('publishers.all')); ?>",
        ...
        $(function () {
            $('#form-create').submit(function (e) {
                ...
                $.ajax({
                    type: 'post',
                    url: '<?php echo e(route('publishers.store')); ?>',
                    data: dataForm,
                    success: function (data) {
        ...
        $(function () {
            $('#form-edit').submit(function (e) {
                ...
                e.preventDefault();
                var url = '<?php echo e(route('publishers.update')); ?>';
                $.ajax({
                    type: 'POST',
                    url: url,
                    data: dataForm,
        ...
        function changeStatusToggle(rowId){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo e(route('publishers.change-status')); ?>',
                data: {
        ...
        function remove(id){
            ...
            swal({
                ...
                if (result.value) {
                    ...
                    var url = '<?php echo e(route('publishers.destroy')); ?>';
                    $.ajax({
                        type: 'POST',
                        url: url,
                        data: {
