    ...
    <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="<?php echo e(Storage::url(Auth::user()->avatar)); ?>" class="user-image">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="user-header">
                        ...
                        <p>
                            ...
                            <small>Último Acceso : <?php echo e(Auth::user()->last_login_date ? (new DateTime(Auth::user()->last_login_date))->format('d-m-Y H:i:s') : 'nunca'); ?></small>
                        </p>
                    </li>
                    <!-- Menu Body -->
