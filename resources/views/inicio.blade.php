                ...
                <div class="container">
                    <nav class="navbar navbar-default">
                        ...
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#">Biblioca Online<!--img src="https://www.guerra-creativa.com/img/uploads/designs/innpgmr0.jpg" width="20%" alt=""--></a>
                        </div>
        ...
        <section class="great_feature_area" id="feature">
            <div class="container">
                <div class="great_title">
                    ...
                    <p>En esta sección encontrarás los resultados de busqueda de libros.</p>
                </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Todos los derechos reservados |  <i class="fa fa-heart-o" aria-hidden="true"></i>  2018
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>
